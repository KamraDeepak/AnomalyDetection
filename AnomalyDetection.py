# -*- coding: utf-8 -*-
"""
Created on Fri Jan 20 14:36:35 2023
...
train_image_directory = 'D:/Deepak/Mtech/Sem4/Anomaly Detection/carpet/train/'
test_image_directory = 'D:/Deepak/Mtech/Sem4/Anomaly Detection/carpet/test/'
bad_image_directory = 'D:/Deepak/Mtech/Sem4/Anomaly Detection/carpet/bad/'

model_path= 'D:/Deepak/Mtech/Sem4/Anomaly Detection/'

SIZE = 64

# Function to read the PNG files from the given path and resizing the image to standar size and RGB
def read_imgs(path, resize='true'):
    
    dataset = []    
    good_images = os.listdir(path)
...
train = read_imgs(train_image_directory)
test = read_imgs(test_image_directory)
bad = read_imgs(bad_image_directory)


#converting the array to flot and values between 0 to 1
train = train.astype('float32') / 255.
test = test.astype('float32') / 255.
bad_dataset = bad.astype('float32') / 255.
...
save_detector(od, model_path + "saved_outlier_models/carpet_od_20epochs.h5")
